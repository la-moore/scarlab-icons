...
function SvgComponent(props) {
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="scarlab scarlab-lock-open" {...props}>
	...
	<path d="M9 9V5C9 3.89543 9.89543 3 11 3H13.0625C14.1326 3 15 3.86745 15 4.9375V4.9375V5" />
  </svg>
}
