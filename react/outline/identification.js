...
function SvgComponent(props) {
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="scarlab scarlab-identification" {...props}>
	...
	<path d="M11.6521 15C11.1982 14.2388 10.3888 14 9.00001 14C8.11946 14 7 14 7 14" />
	<path d="M12 9L17 9" />
	<path d="M13 12L17 12" />
	<path d="M15 15H17" />
  </svg>
