...
function SvgComponent(props) {
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="scarlab scarlab-folder-check" {...props}>
	...
	<path d="M9 14L10.9145 15.9145V15.9145C10.9617 15.9617 11.0383 15.9617 11.0855 15.9145V15.9145L16 11" />
  </svg>
}
