...
export default function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
	...
	_createElementVNode("path", {"d":"M20.9177 8.00419C20.4975 5.4883 18.5117 3.50251 15.9958 3.08226C15.4511 2.99127 15 3.44772 15 4L15 8C15 8.55228 15.4477 9 16 9L20 9C20.5523 9 21.0087 8.54893 20.9177 8.00419Z"})
  ]))
}
