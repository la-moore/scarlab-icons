...
export default function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
	...
	"class": "scarlab scarlab-folder-check",
    ..._ctx
  }, [
	...
	_createElementVNode("path", {"d":"M9 14L10.9145 15.9145V15.9145C10.9617 15.9617 11.0383 15.9617 11.0855 15.9145V15.9145L16 11"})
  ]))
}
