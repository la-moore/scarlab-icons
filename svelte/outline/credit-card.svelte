<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="scarlab scarlab-credit-card" {...$$props}>
    <path d="M3.5 10H20.5" />
	<path d="M6 14H8" />
	<path d="M11 14H13" />
